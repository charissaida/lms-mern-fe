...
const RefleksiAnswerDetail = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (submissionData.score !== null && submissionData.score !== undefined) {
          ...
          const finalScore = calculateFinalScore(essayInit, 0, taskData); // mcqScore is 0 for refleksi
  ...
  const handleScoreSubmit = async () => {
    ...
    try {
      ...
      await axiosInstance.put(API_PATHS.TASKS.POST_SUBMISSION_SCORE("refleksi", taskId, userId), { score });
