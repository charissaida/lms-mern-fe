...
const PretestAnswerDetail = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (submissionData.score !== null && submissionData.score !== undefined) {
          // Jika sudah ada skor tersimpan, gunakan itu sebagai nilai utama.
          setScore(submissionData.score);
        } else {
          // Jika belum ada skor, baru hitung otomatis sebagai nilai awal.
  ...
  const handleScoreSubmit = async () => {
    ...
    try {
      ...
      await axiosInstance.put(API_PATHS.TASKS.POST_SUBMISSION_SCORE("pretest", taskId, userId), { score });
