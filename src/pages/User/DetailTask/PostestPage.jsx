...
const PostestPage = () => {
  ...
  useEffect(() => {
    ...
    const getSubmission = async () => {
      try {
        const res = await axiosInstance.get(API_PATHS.TASKS.GET_SUBMISSION_BY_ID_USER("postest", user._id));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post(API_PATHS.TASKS.POST_SUBMISSION_BY_TASK_ID("postest", id), payload);
        ...
        <div className="flex-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              onClick={() => navigate(`/user/postest/result/${id}`)}
            >
              Nilai
            </button>
          </form>
