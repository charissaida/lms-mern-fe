    ...
    <div className="user-card p-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img
            src={userInfo?.profileImageUrl && userInfo.profileImageUrl.trim() !== "" ? userInfo.profileImageUrl : `https://ui-avatars.com/api/?name=${encodeURIComponent(userInfo?.name || "User")}`}
            alt={`Avatar`}
